...
if __name__ == '__main__':
    ...
    frames_num = 256
    pr_path = r'/scratch/project_2006419/HKUST_GZ/Griep_all/Result/Greip_all_sort54HR_pr.mat'
    gt_path = r'/scratch/project_2006419/HKUST_GZ/Griep_all/Result/Greip_all_sort54HR_rel.mat'
    Idex_files = r'/scratch/project_2006419/HKUST_GZ/dataset/VIPL_Index/VIPL_STMap51254_Test'
    ...
    for HR_index in range(pr.size-1):
        ...
        if lastPath != nowPath:
            if pr_temp is None:
                ...
                if all(np.isnan(pr_temp)) or all(np.isnan(gt_temp)):
                    print(pr_temp)
                    print(gt_temp)
                    print(lastPath, nowPath, lastPath != nowPath)
                else:
